...
router
  .route("/fetch-nearby-users")
  .get(isAuthenticated, fetchNearbyUsersLimiter, nearbyUsers);
...
router
  .route("/search-group")
  .get(isAuthenticated, searchGroupLimiter, searchGroups);
...
router
  .route("/nearby-groups")
  .get(isAuthenticated, findNearbyGroupsLimiter, fetchNearbyGroups);
